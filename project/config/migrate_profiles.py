...
def migrate_data():
    ...
    try:
        ...
        # Gwarantujemy linterowi, że z pd.to_numeric wychodzi Series, by bezpiecznie użyć fillna
        setting_time_s = pd.Series(pd.to_numeric(df["setting_time"], errors="coerce"))
        df["setting_time"] = setting_time_s.fillna(0).astype(int)
    ...
    try:
        ...
        with engine.begin() as conn:
            ...
            print("Zapisywanie poprawnie sformatowanych danych...")
